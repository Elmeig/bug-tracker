...
| Rol | Permisos |
|---|---|
| **admin** | Todo: crear/editar/borrar listas y bugs, gestionar usuarios, backup/restore |
| **user** | Crear/editar bugs, añadir comentarios, marcar como resuelto |
